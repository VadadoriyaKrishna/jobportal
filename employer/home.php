        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              ...
              <?php $query=mysqli_query($conn,"Select * from tbljobregistration");
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              ...
              <?php $query=mysqli_query($conn,"Select * from tblcompany");
$totalcompany=mysqli_num_rows($query);
...
?>
            ...
            <a href="../admin/company/" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
      ...
      <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
            <?php $query=mysqli_query($conn,"Select * from tbljob");
$totalvacancy=mysqli_num_rows($query);

?>

            <h3><?php echo $totalvacancy; ?></h3>
...
$totalcategory=mysqli_num_rows($query);
