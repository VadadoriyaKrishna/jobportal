   ...
   <!-- Slider -->
         <div id="main-slider" class="flexslider">
             <ul class="slides">
               <li>
                 <img src="<?php echo web_root; ?>plugins/home-plugins/img/slides/bg7.jpg" alt="" />
  ...
  <section id="call-to-action-2" style="background-color:#F2F2F2;margin-top:50px;">
    <div class="container">
      <div class="row">
                ...
                <div class="block-heading-two">
                  <h3><span>Testimonials</span></h3>
                    ...
                    <div class="active item">
                      ...
                      <!--img alt="" src="plugins/home-plugins/img/slides/team4.jpg" class="pull-left">
                      <div class="pull-left">
