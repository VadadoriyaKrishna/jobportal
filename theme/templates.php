              ...
              <div class="col-md-12">      
                ...
                <?php if (isset($_SESSION['APPLICANTID'])) { 
                    ...
                    echo ' <p class="pull-right login"><a title="View Notification(s)" href="'.web_root.'applicant/index.php?view=notification"> <i class="fa fa-bell-o"></i> <span class="label label-success">'.$notif.'</span></a> | <a title="View Message(s)" href="'.web_root.'applicant/index.php?view=message"> <i class="fa fa-envelope-o"></i> <span class="label label-success">'.$msg.'</span></a> | <a title="View Profile" href="'.web_root.'applicant/"> <i class="fa fa-user"></i>  '. $appl->FNAME. ' '.$appl->LNAME .' </a> | <a href="'.web_root.'logout.php">  <i class="fa fa-sign-out"> </i>Logout</a> </p>';
                      ...
                      <p   class="pull-right login"><a data-target="#myModal" data-toggle="modal" href=""> <i class="fa fa-lock"></i> Login </a></p>x
                <?php } ?>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">TimesJobs<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
      ...
      if (isset($_GET['q'])) {
        ...
        echo '<section id="inner-headline">
            <div class="container-fluid" style="background-color:#f8f8f8;">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="pageTitle" style="color:#1891EC;">'.$title.'</h2>
                    </div>
                </div>
            </div>
            </section>';
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          Times Jobs<br>
           Pin-395008 Surat, Gujarat, India.</address>
          <p>
            <i class="icon-phone"></i> 9727374054 <br>
            <i class="icon-envelope-alt"></i> timesjobs@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
