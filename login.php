              ...
              <div class="modal-content">
                ...
                <!-- <form action="process.php?action=login" enctype="multipart/form-data" method="post"> -->
                  <div class="modal-body hold-transition login-page">
                    ...
                    <div class="login-box"> 
                        <div class="login-box-body" style="border: solid 1px #ddd;padding: 35px;min-height: 270px;"> 
                  ...
                  <div class="modal-footer">
                    ...
                    name="btnlogin" id="btnlogin"  ><a href="../jobportal/admin" style="color: white;">Admin Login</a></button>
                    <button class="btn btn-primary"
                    name="btnlogin" id="btnlogin"  ><a href="../jobportal/employer" style="color: white;">Employer Login</a></button>
                  </div>
                <!-- </form> -->
              </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
